...
const AdminOrders = () => {
  ...
  const setDeliveryPersons = useStore((state) => state.setDeliveryPersons);
          ...
          (snapshot) => {
            ...
            snapshot.docs.forEach((doc) => {
              try {
                ...
                console.error(
                  "Error processing order document:",
                  doc.id,
                  error
                );
              }
    ...
    >
      <View style={styles.orderHeader}>
        <Text style={styles.orderNumber}>
          Order #{item.orderNumber || item.id.slice(-5).toUpperCase()}
        </Text>
        <View
          style={[
            styles.orderStatus,
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              if (item.status === "pending") {
                ...
                Alert.alert(
                  "Print",
                  "Receipt printing functionality would go here"
                );
              }
            }}
          >
